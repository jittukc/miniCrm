							...
							@foreach ($employees->items() as $employee)
                                    <tr>
                                        ...
                                        <td>
											...
											<a href="#addEmployeeModal{{ $employee->id }}" class="btn" data-toggle="modal">Edit</a>
									...
									<div id="addEmployeeModal{{ $employee->id }}" class="modal fade">
                    ...
                    <div class="form-group">
                        ...
                        <select name="company_id" id="company_id" class="form-control" required>
                            @foreach($companies as $company)
                                <option value="{{ $company->id }}" @if($employee->company_id == $company->id) selected="selected" @endif>{{ $company->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
